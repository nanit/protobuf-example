...
- (void) storeInDictionary:(NSMutableDictionary *)dictionary {
  ...
  for (PersonPhoneNumber* element in self.phoneArray) {
    ...
    [dictionary setObject:[NSDictionary dictionaryWithDictionary:elementDictionary] forKey:@"phone"];
  }
...
@property (strong) AddressBook* resultAddressBook;
@end

@implementation AddressBookBuilder
@synthesize resultAddressBook;
- (instancetype) init {
  if ((self = [super init])) {
    self.resultAddressBook = [[AddressBook alloc] init];
  }
  return self;
}
- (PBGeneratedMessage*) internalGetResult {
...
- (AddressBookBuilder*) clone {
  return [AddressBook builderWithPrototype:resultAddressBook];
}
...
- (AddressBook*) buildPartial {
  AddressBook* returnMe = resultAddressBook;
  self.resultAddressBook = nil;
  return returnMe;
}
- (AddressBookBuilder*) mergeFrom:(AddressBook*) other {
  ...
  if (other.personArray.count > 0) {
    if (resultAddressBook.personArray == nil) {
      resultAddressBook.personArray = [[NSMutableArray alloc] initWithArray:other.personArray];
    } else {
      [resultAddressBook.personArray addObjectsFromArray:other.personArray];
    }
  }
  [self mergeUnknownFields:other.unknownFields];
  return self;
...
- (NSMutableArray *)person {
  return resultAddressBook.personArray;
}
- (Person*)personAtIndex:(NSUInteger)index {
  return [resultAddressBook personAtIndex:index];
}
- (AddressBookBuilder *)addPerson:(Person*)value {
  if (resultAddressBook.personArray == nil) {
    resultAddressBook.personArray = [[NSMutableArray alloc]init];
  }
  [resultAddressBook.personArray addObject:value];
  return self;
}
- (AddressBookBuilder *)setPersonArray:(NSArray *)array {
  resultAddressBook.personArray = [[NSMutableArray alloc]initWithArray:array];
  return self;
}
- (AddressBookBuilder *)clearPerson {
  resultAddressBook.personArray = nil;
  return self;
}
@end
